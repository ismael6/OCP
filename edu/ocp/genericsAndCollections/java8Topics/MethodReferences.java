...
public class MethodReferences {
	...
	//	BiPredicate<String, String> typeMethodReference = String::isEmpty; // NOT COMPILES!! number of arguments taken by functional interface must exactly match instance + number of arguments
																			// (number of arguments = 2 VS instance + method arguments = 1)
		
	// On instance method references, the instance itself can be used as part of the functional interface arguments
	// So carefully match arguments on functional interface with instance + argument values		
		Predicate<String> methodReference = String :: isEmpty; //the only one parameterized value is used for the instance
		

	// instance access (functional interface have 1 argument and method have one argument (instance + argument = 2 parameterized types needed))
		String str = "b";
	...
	// type access (functional interface uses two arguments(one is used for instance and one is used for method argument))
		String strB = "b";
